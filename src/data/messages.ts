...
export const messages: Array<ChatMessage> = [
  ...
  },
  {
    ...
    profileImage: require('@/assets/images/eric.png'),
    type: 'text',
    message: 'Welcome to the Holochain group on Junto. All of this is fully decentralized and powered by this exciting new framework :)',
    timestamp: new Date(Date.UTC(2021, 3, 21, 10, 20, 30)),
  }, {
    id: 2,
    username: 'eric',
  ...
  },
  {
    ...
    profileImage: require('@/assets/images/eric.png'),
    type: 'text',
    message: "You'll also be able to create channels (sub-conversations) to organize your discussions into topics. Give it a go!",
    timestamp: new Date(Date.UTC(2021, 3, 21, 10, 20, 30)),
  },
  ...
  },
  {
    ...
    profileImage: require('@/assets/images/josh.png'),
    type: 'text',
    message: "Feel free to check out the AD4M framework we've been developing this platform with as well",
    timestamp: new Date(Date.UTC(2021, 3, 21, 10, 25, 30)),
  },
  {
    id: 2,
    ...
    profileImage: require('@/assets/images/josh.png'),
    type: 'text',
    message: "AD4M is a meta-ontology designed to create more interopability between user interfaces.",
    timestamp: new Date(Date.UTC(2021, 3, 21, 10, 25, 30)),
  },
  {
    id: 2,
    ...
    profileImage: require('@/assets/images/josh.png'),
    type: 'text',
    message: "You can read more about it on the documentation hosted at our Github here: https://ad4m.dev",
    timestamp: new Date(Date.UTC(2021, 3, 21, 10, 25, 30)),
  },
  {
    id: 2,
  ...
  },
  {
    ...
    profileImage: require('@/assets/images/eric.png'),
    type: 'text',
    message: "Eventally, we'll build this out so communities can have not only a newsfeed and "
  ...
  },
  {
    ...
    profileImage: require('@/assets/images/eric.png'),
    type: 'text',
    message: "Each feed, channel, and view is its own Holochain DNA so it allows for full customizability, " +
  ...
  },
  {
    ...
    profileImage: require('@/assets/images/eric.png'),
    type: 'text',
    message: "Basically a service where you have all the features of Slack and Notion, " +
